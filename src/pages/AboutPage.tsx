    ...
    <MainLayout>
      <div className="min-h-screen bg-background pb-20 lg:pb-8">
        <header className="sticky top-0 z-40 bg-background border-b border-border px-4 py-3 flex items-center gap-3 lg:px-6">
          ...
          <h1 className="text-lg font-semibold text-foreground lg:text-xl">About Us</h1>
        </header>
        ...
        <div className="px-4 py-6 space-y-8 lg:px-6">
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <section className="text-center">
              <div className="w-24 h-24 bg-gradient-to-br from-primary to-primary/60 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg lg:w-32 lg:h-32">
                <span className="text-3xl font-bold text-primary-foreground lg:text-4xl">HR</span>
              </div>
              <h2 className="text-2xl font-bold text-foreground mb-2 lg:text-3xl">HpyRide.com</h2>
            ...
            <section className="bg-card border border-border rounded-xl p-6">
              <h3 className="text-lg font-bold text-foreground mb-3 lg:text-xl">Our Story</h3>
            ...
            {/* Services */}
            <section>
              <h3 className="text-lg font-bold text-foreground mb-4 lg:text-xl">Our Services</h3>
            ...
            {/* Vision, Mission, Goal */}
            <section>
              <h3 className="text-lg font-bold text-foreground mb-4 lg:text-xl">What Drives Us</h3>
            ...
            {/* Values */}
            <section>
              <h3 className="text-lg font-bold text-foreground mb-4 lg:text-xl">Our Values</h3>
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-3">
            ...
            <section className="bg-primary/10 rounded-xl p-6">
              <h3 className="text-lg font-bold text-foreground mb-4 lg:text-xl">Why Choose HpyRide?</h3>
            ...
            <section className="bg-card border border-border rounded-xl p-6 text-center">
              <h3 className="text-lg font-bold text-foreground mb-4 lg:text-xl">Get in Touch</h3>
