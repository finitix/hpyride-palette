    ...
    <MainLayout>
      <div className="min-h-screen bg-background pb-20 lg:pb-8">
        ...
        <header className="sticky top-0 z-40 bg-background border-b border-border px-4 py-3 flex items-center gap-3 lg:px-6">
          ...
          <h1 className="text-lg font-semibold text-foreground lg:text-xl">My Profile</h1>
        </header>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="px-4 py-6 lg:px-6">
            <div className="bg-card rounded-2xl shadow-lg p-6">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-20 h-20 rounded-full bg-secondary flex items-center justify-center lg:w-24 lg:h-24">
                  <User className="w-10 h-10 text-muted-foreground lg:w-12 lg:h-12" />
                </div>
          ...
          <div className="px-4 py-8 lg:px-6">
            <Button
              variant="outline"
              className="w-full lg:w-auto border-destructive text-destructive hover:bg-destructive hover:text-destructive-foreground"
